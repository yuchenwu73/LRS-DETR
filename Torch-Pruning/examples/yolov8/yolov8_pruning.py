...
from ultralytics.nn.modules import Detect, CSPLayer, Conv, Bottleneck
...
def transfer_weights(CSPLayer, CSPLayer_v2):
...
def replace_CSPLayer_with_CSPLayer_v2(module):
    for name, child_module in module.named_children():
        if isinstance(child_module, CSPLayer):
            ...
            transfer_weights(child_module, CSPLayer_v2)
...
def prune(args):
    ...
    model.model.train()
    replace_CSPLayer_with_CSPLayer_v2(model.model)
