...
if __name__ == '__main__':
    ...
    parser.add_argument('--base-weights', type=str, default='choose your base weights', help='base weights path')
    parser.add_argument('--prune-weights', type=str, default='choose your prune weights', help='prune weights path')
