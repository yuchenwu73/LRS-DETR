...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 BottleneckCSP, C1, C2, CSPLayer, C3, C3TR, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x, RepC3,
                 ConvNormLayer, DWRC3, C3_DWR, CSPLayer_DWR, DEFBlock, SPDConv):
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
            ...
            if m in (BottleneckCSP, C1, C2, CSPLayer, C3, C3TR, C3Ghost, C3x, RepC3, DWRC3, C3_DWR, CSPLayer_DWR, DEFBlock):
                args.insert(2, n)  # number of repeats
                n = 1
        elif m in (AIFI, TransformerEncoderLayer_LocalWindowAttention, DPRA):
            args = [ch[f], *args]
